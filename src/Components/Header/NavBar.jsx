        ...
        <div className="navbar ">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-gradient-to-r from-[#e3e9ed]  to-[#fcfcfd]  text-[#3C3E41] mt-7 md:mt-8 w-75 h-screen px-6  md:px-10 py-6 -ml-18 md:-ml-32 shadow-md gap-2 ">
          ...
          <div className="navbar-end gap-6">
            <button
              ...
              className=" btn  md:btn-md lg:btn-lg xl:btn-xl text-[#fc2164] bg-gradient-to-r from-[#e3e9ed] to-[#fcfcfd] rounded-lg shadow-lg border-none font-poppins font-semibold hover:transition hover:scale-105 cursor-pointer"
            >
              Hire Me
            </button>
          </div>
